...
for(pcc_cutoff_item in PCC_cutoff){
  ...
  for (ii in projects[2:9]) {
    ...
    # temp_term_list <- read.xlsx("./generalized_Ctrl_summary.xlsx",sheet =ii)
    temp_term_list <- read.xlsx(paste0("./085/",pcc_cutoff_item,"/","generalized_Ctrl_summary_",pcc_cutoff_item,".xlsx"),sheet =ii)
  ...
  # write.xlsx(up_regulated_list_order,file = "./generalized_Ctrl_summary_order.xlsx")
  write.xlsx(up_regulated_list_order,file = paste0("./085/",pcc_cutoff_item,"/","generalized_Ctrl_summary_order_",pcc_cutoff_item,".xlsx"))
  
  names(up_regulated_list_common) <- projects[2:9]
  # write.xlsx(up_regulated_list_common,file = "./generalized_Ctrl_summary_order_common.xlsx")
  write.xlsx(up_regulated_list_common,file = paste0("./085/",pcc_cutoff_item,"/","generalized_Ctrl_summary_order_common_",pcc_cutoff_item,".xlsx"))
  
  names(up_regulated_list_unqiue) <- projects[2:9]
  # write.xlsx(up_regulated_list_unqiue,file = "./generalized_Ctrl_summary_order_unique.xlsx")
  write.xlsx(up_regulated_list_unqiue,file = paste0("./085/",pcc_cutoff_item,"/","generalized_Ctrl_summary_order_unique_",pcc_cutoff_item,".xlsx"))
