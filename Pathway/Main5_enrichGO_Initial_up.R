...
# This code is used to obtain the enrichment analysis initial enrichment analysis for up-regulated groups.
...
for(project in projects[c(2:9)]){
  ...
  enrichGO_result_I <- enrichGO(gene = DEGs_Stage_I_upregulated, 
                              ont = "BP", 
                              keyType  = 'SYMBOL',
                              OrgDb ="org.Hs.eg.db",
                              pvalueCutoff = 0.05)
  ...
  enrichGO_result_II <- enrichGO(gene = DEGs_Stage_II_upregulated, 
                                ont = "BP", 
                                keyType  = 'SYMBOL',
                                OrgDb ="org.Hs.eg.db",
                                pvalueCutoff = 0.05)
  ...
  enrichGO_result_III <- enrichGO(gene = DEGs_Stage_III_upregulated, 
                                 ont = "BP", 
                                 keyType  = 'SYMBOL',
                                 OrgDb ="org.Hs.eg.db",
                                 pvalueCutoff = 0.05)
  ...
  enrichGO_result_IV <- enrichGO(gene = DEGs_Stage_IV_upregulated, 
                                  ont = "BP", 
                                  keyType  = 'SYMBOL',
                                  OrgDb ="org.Hs.eg.db",
                                  pvalueCutoff = 0.05)
  ...
  save(enrichGO_result_I.result,enrichGO_result_I_sim_085.result,
       ...
       file = paste("./main5_enrichGO_results_Initial_up/",project,"_enrichGO_results.Rdata",sep = ""))
